...
const services = [
  { type: "text", title: "OUR SERVICES", description: "At Stronger, one size does not fit all! We have a plan for everyone!", span: "col-span-2 row-span-1" ,location:""},
  { image: GymImage1, title: "About us", description: "Customized workout plans with expert trainers.", span: "col-span-1 row-span-1" ,location:"/AboutPage"},
  { image: GymImage2, title: "OUR COACH", description: "Meet our certified coaches dedicated to helping you grow stronger every day.", span: "col-span-1 row-span-2" ,location:"/CoachPage"},
  { image: GymImage3, title: "OUR PRODUCTS", description: "High-quality fitness gear and supplements tailored for performance.", span: "col-span-1 row-span-1" ,location:"/ProductsPage"},
  { image: GymImage4, title: "MEDICAL FITNESS", description: "Programs designed for recovery and rehabilitation with expert support.", span: "col-span-1 row-span-2" ,location:""},
  { image: GymImage5, title: "BODY TRANSFORMATION GALLERY", description: "Real transformations from real people who committed to change.", span: "col-span-1 row-span-1" ,location:"/ProgressGallery"},
];

const ServiceCard = ({ image, title, description, type, span,location }) => {
      ...
      {type === "text" ? (
        ...
        <>
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center text-center bg-black bg-opacity-70 opacity-0 group-hover:opacity-100 transition-opacity duration-300 px-4">
            ...
            <button className="mt-4 bg-white text-black px-4 py-2 rounded-full shadow hover:bg-yellow-300 transition-all duration-200" onClick={()=>navigate(location)}>
